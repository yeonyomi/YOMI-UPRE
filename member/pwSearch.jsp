...
<body>
		...
		<main
			...
			<div class="mb-3"
				...
				<input type="text" class="form-control" id="name_input2" name="name"
					placeholder="Name"><div id="nameError" style="color: red;"></div>
	...
	$(document).ready(function() {
	    ...
	    $('#pw_search').on('click', function(e) {
	        var name = $('#name_input2').val();
	        var id = $('#id_input').val();
	        var mail = $('#mail_input2').val();
	        ...
	        $('#search_form').attr('action', '/member/pwSearch');
	        $('#search_form').submit(); 
	    });
	});
